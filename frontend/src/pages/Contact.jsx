...
//             <li>📍 Nairobi, Kenya</li>
//             <li>📧 support@SystemAgents.com</li>
//             <li>📞 +254 745 362 943</li>
//           </ul>
...
//     try {
//       await axios.post("http://localhost:3000/api/contact", formData); // 🔹 sends to backend
...
export default function Contact() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const res = await fetch("https://formspree.io/f/xnnbwybq", {
        method: "POST",
        body: data,
        headers: {
